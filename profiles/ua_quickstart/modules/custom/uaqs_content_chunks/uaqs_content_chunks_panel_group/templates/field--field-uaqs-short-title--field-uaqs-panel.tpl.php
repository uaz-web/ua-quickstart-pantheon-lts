 ...
 */
?>
<div class="panel-heading panel-title h4" id="heading-<?php print $collapseid; ?>">
  <a type="button" data-toggle="collapse" data-parent="#accordion" href="#<?php print $collapseid; ?>" aria-expanded="<?php print $aria_expanded; ?>" aria-controls="<?php print $collapseid; ?>" role="tab">
